...
## AI Draft Analysis (experimental)

This fork adds a lightweight AI draft analyzer for champion select.

### What it does
- Calculates a quick team-balance/risk score from ally recent games.
- Produces actionable suggestions (`next_actions`) and build hints.
- Emits analysis via `signalBus.aiDraftAnalysisUpdated` and shows a short InfoBar summary.

### Env variables (optional)
- `SERAPHINE_AI_API_KEY`
- `SERAPHINE_AI_BASE_URL` (default: `https://api.openai.com/v1`)
- `SERAPHINE_AI_MODEL` (default: `gpt-4o-mini`)
